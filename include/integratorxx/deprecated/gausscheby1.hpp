...
class GenerateQuadrature<
    GaussChebyshev1<PointType, wght_t, ContiguousContainer> > {
  using point_container =
      typename GaussChebyshev1<PointType, wght_t,
  ...
  /**
   *  \brief Generate the Gauss-Chebyshev (1st kind) quadrature rule of a
   * specific order (impl)
   *
